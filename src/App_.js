...
const Header = ({ children, size = "200px" }) =>
    ...
    return (
      ...
      <header className="App-header">
        ...
        {name}
            ...
            <Header size='100px'>Hello</Header>
            <Add a={5} b={3} />
            <Add a={3} b={3} />
            <Add a={134234} b={543} />
            <Add a={0} b={3} />
